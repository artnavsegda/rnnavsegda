...
import {Dimensions, Animated, PanResponder, StyleSheet, TouchableOpacity, ViewPropTypes, View} from 'react-native';
...
class SwipeRow extends Component {
    constructor(props) {
        ...
        this._panResponder = PanResponder.create({
            ...
            onPanResponderGrant: (e, gs) => this.handlePanResponderGrant(e, gs),
        ...
        if (this.props.forceCloseToRightThreshold && this.props.forceCloseToRightThreshold > 0) {
            this._translateX.addListener(({value}) => {
                if (
                    !this.isForceClosing &&
                    Dimensions.get('window').width + value < this.props.forceCloseToRightThreshold
                ) {
        ...
        if (this.props.forceCloseToLeftThreshold && this.props.forceCloseToRightThreshold > 0) {
            this._translateX.addListener(({value}) => {
                if (
                    !this.isForceClosing &&
                    Dimensions.get('window').width - value < this.props.forceCloseToLeftThreshold
                ) {
                    this.isForceClosing = true;
    ...
    doFullAnimation() {
        ...
        return this.getPreviewAnimation(previewOpenValue, this.props.previewOpenDelay).start(() => {
    ...
    handlePanResponderGrant(e, gestureState) {
        this.props.onPanResponderGrant && this.props.onPanResponderGrant(e, gestureState);
    }

    handlePanResponderEnd(e, gestureState) {
        this.props.onPanResponderRelease && this.props.onPanResponderRelease(e, gestureState);
        /* Pan end will reset the force-closing state when it's true. */
        if (this.isForceClosing) {
            // noinspection JSUnresolvedFunction
            setTimeout(() => {
                this.isForceClosing = false;
    ...
    renderVisibleContent() {
        ...
        return (
            <TouchableOpacity activeOpacity={1} onPress={this.combinedOnPress} accessible={false}>
            ...
            return (
                <Animated.View
                    ...
                    style={{
                        ...
                        transform: [
                            {
                                translateX: this.props.translateBuilder(this._translateX),
                            },
                        ],
                    }}>
            ...
            <View style={this.props.style ? this.props.style : styles.container}>
                <Animated.View
                    style={[
                        ...
                        this.props.withOpacity
                            ? {
                                  opacity: this.props.opacityBuilder(this._translateX),
                              }
                            : undefined,
                    ]}>
...
SwipeRow.propTypes = {
    ...
    // Other
    opacityBuilder: PropTypes.func,
    translateBuilder: PropTypes.func,
