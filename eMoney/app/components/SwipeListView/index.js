...
// Fork https://github.com/jemise111/react-native-swipe-list-view
// Don't update / remove it component
...
class SwipeListView extends Component {
        ...
        if (!HiddenComponent) {
            ...
            return (
                <SwipeRow
                    ...
                    ref={row => (this._rows[key] = row)}
                    opacityBuilder={this.props.opacityBuilder}
                    translateBuilder={this.props.translateBuilder}
                    ...
                    onRowDidOpen={toValue =>
                        this.props.onRowDidOpen && this.props.onRowDidOpen(key, this._rows, toValue)
                    }
                    onRowClose={() => this.props.onRowClose && this.props.onRowClose(key, this._rows)}
                    onRowDidClose={() => this.props.onRowDidClose && this.props.onRowDidClose(key, this._rows)}
                    ...
                    shouldItemUpdate={
                        this.props.shouldItemUpdate
                            ? (currentItem, newItem) => this.props.shouldItemUpdate(currentItem, newItem)
                            : null
                    }
                    setScrollEnabled={enable => this.setScrollEnabled(enable)}
                    ...
                    withOpacity={this.props.withOpacity}
    ...
    renderRow(rowData, secId, rowId, rowMap) {
        ...
        return this.renderCell(
            ...
            this.props.renderHiddenRow && this.props.renderHiddenRow(rowData, secId, rowId, rowMap),
            key,
            rowData,
            shouldPreviewRow,
        );
    ...
    renderItem(rowData, rowMap) {
        ...
        return this.renderCell(
            this.props.renderItem(rowData, rowMap),
            this.props.renderHiddenItem && this.props.renderHiddenItem(rowData, rowMap),
            key,
            item,
            shouldPreviewRow,
        );
...
SwipeListView.propTypes = {
    // With opacity animation and use opacityBuilder
